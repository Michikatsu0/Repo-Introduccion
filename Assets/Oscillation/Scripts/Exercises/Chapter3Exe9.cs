...
public class Chapter3Exe9 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        foreach (Transform waveTransform in waveTransforms)
        {
            ...
            float yCoord = currentAngle / (float)Math.PI;
            float currentY = Mathf.Lerp(-maximumPos.y, maximumPos.y, Mathf.InverseLerp(0, 1f, Mathf.PerlinNoise(yCoord, 0)));
