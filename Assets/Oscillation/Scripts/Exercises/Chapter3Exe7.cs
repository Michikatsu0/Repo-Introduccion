...
public class Chapter3Exe7 : MonoBehaviour
{
    [SerializeField] private float period = 5f;
    [SerializeField] private float xVP, xVN, yVP,yVN;

    private List<Oscillator3_E7> oscilattors = new List<Oscillator3_E7>();
    ...
    IEnumerator WaitForFunction()
    {
        ...
        {
            oscilattors.Add(new Oscillator3_E7(period));
    ...
    void FixedUpdate()
    {
        ...
        foreach (Oscillator3_E7 o in oscilattors)
        {
...
public class Oscillator3_E7
{
    ...
    public Oscillator3_E7(float period)
    {
        FindWindowLimits();
