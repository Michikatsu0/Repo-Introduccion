...
public class Chapter4Fig2 : MonoBehaviour
{
    ...
    void createParticleSystem(Vector3 origin)
    {
        ...
        psf2 = new particleSystemFigure2(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles, mat);
    }
    ...
    void createParticleSystem(Vector3 origin, GameObject parentParticleSystem)
    {
        ...
        particleSystemFigure2 child = new particleSystemFigure2(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles, mat);
...
public class particleSystemFigure2
{
    ...
    public particleSystemFigure2(Vector3 particleSystemLocation, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles, Material mat)
    {
