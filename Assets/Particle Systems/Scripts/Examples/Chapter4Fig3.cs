...
public class Chapter4Fig3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        maxParticles = 1000;
        psf3 = new particleSystemFigure3(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles,mat);
    }
}
...
public class particleSystemFigure3
{
    ...
    public particleSystemFigure3(Vector3 particleSystemLocation, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles,Material mat)
    {
    ...
    public void trailModule(Material mat)
    {
