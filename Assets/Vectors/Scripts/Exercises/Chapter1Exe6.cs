...
public class Chapter1Exe6 : MonoBehaviour
{
    // Declare a mover object
    private Mover1_6 mover;
...
public class Mover1_6
{
    // The basic properties of a mover class
    private Vector2 location, velocity, acceleration, rangeScale, distanceScale;
    ...
    public void Step()
    {
        float width = rangeScale.x * Mathf.PerlinNoise(Time.time * distanceScale.x, 0.0f) * Time.deltaTime;
        float height = rangeScale.y * Mathf.PerlinNoise(0.0f, Time.time * distanceScale.y) * Time.deltaTime;
