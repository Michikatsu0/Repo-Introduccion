...
public class Chapter1Exe8 : MonoBehaviour
{
    // Declare a mover
    Mover1_E8 mover;
    ...
    void Update()
    {
        ...
        float accelerationMagnitude =  Time.deltaTime / distance;

        mover.acceleration = mover.ScaleVector(dir.normalized, accelerationMagnitude * 500);
