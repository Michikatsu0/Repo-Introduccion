...
public class Step2_1 : MonoBehaviour
{
    ...
    [SerializeField] float radiusX, radiusY, angularVelocity;
    // Create a list of Movers 
    List<Mover2_Step2_1> movers = new List<Mover2_Step2_1>();
    Attractor2_Step2_1 attractor;
    Vector2 position;
    float angle;
    ...
    void Start()
    {
        ...
        while (movers.Count < 30)
        {
            ...
            movers.Add(new Mover2_Step2_1(moverSpawnTransform.position, leftWallX, rightWallX, ceilingY, floorY));
        }
        attractor = new Attractor2_Step2_1();
    }
    ...
    void Update()
    {
        ...
        attractor.UpdatePosition(position);

        foreach (Mover2_Step2_1 mover in movers)
        {
...
public class Attractor2_Step2_1
{
...
public class Mover2_Step2_1
{
    ...
    public Mover2_Step2_1(Vector3 position, float xMin, float xMax, float yMin, float yMax)
    {
        this.xMin = xMin;
        this.xMax = xMax;
        this.yMin = yMin;
