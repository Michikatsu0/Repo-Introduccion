...
public class Chapter2Exe7 : MonoBehaviour
{
    ...
    [SerializeField] float Liftdrag;
    // Create our lists
    private List<Mover2_E7> movers = new List<Mover2_E7>();
    private List<Fluid2_E7> fluids = new List<Fluid2_E7>();
    ...
    void Start()
    {
        ...
        {
            movers.Add(new Mover2_E7(moverSpawnTransform.position, leftWallX, rightWallX, floorY));
        }

        // Add the fluid to our scene
        fluids.Add(new Fluid2_E7(fluidCornerA.position, fluidCornerB.position, fluidDrag, waterMaterial));
    }
    ...
    void FixedUpdate()
    {
        ...
        foreach (Mover2_E7 mover in movers)
        {
            // Check for interaction with any of our fluids
            foreach (Fluid2_E7 fluid in fluids)
            {
...
public class Mover2_E7
{
    ...
    public Mover2_E7(Vector3 position, float xMin, float xMax, float yMin)
    {
        this.xMin = xMin;
        this.xMax = xMax;
        this.yMin = yMin;
    ...
    public bool IsInside(Fluid2_E7 fluid)
    {
...
public class Fluid2_E7
{
    public Vector3 minBoundary;
    public Vector3 maxBoundary;
    public float dragCoefficient;

    public Fluid2_E7(Vector3 corner1, Vector3 corner2, float dragCoefficient, Material material)
    {
